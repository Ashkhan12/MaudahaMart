          ...
          <div className="flex justify-between items-center border-b border-slate-50 pb-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <button type="button" 
                ...
                className="lg:hidden p-1 bg-slate-100 hover:bg-slate-200 rounded-full text-slate-500 cursor-pointer"
              >
                <X className="h-4 w-4" />
              </button>
            </div>
            ...
            {activeRestaurantCart.length === 0 ? (
              ...
              <div className="space-y-4">
                ...
                {subtotal < currentRestaurant.minOrder && (
                  <p className="text-[10px] text-amber-600 text-center font-bold cursor-pointer">
